...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8019430504:AAEkMjozoEQ05Dj9L1tjcmVbVhb43ePtWEs")

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 1757925205 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/13",
        "https://t.me/forward_hack_lnx/14",
        "https://t.me/forward_hack_lnx/44"
    ]
